...
Rails.application.config.assets.precompile += %w( aircrafts.css.scss )
Rails.application.config.assets.precompile += %w( aircrafts.js )
Rails.application.config.assets.precompile += %w( aircraft_detail.css.scss )
...
Rails.application.config.assets.precompile += %w( report_detail.css.scss )
